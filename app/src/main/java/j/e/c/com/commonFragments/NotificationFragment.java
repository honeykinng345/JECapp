...
import j.e.c.com.commonFragments.Adapters.NotificationAdapter;
...
public class NotificationFragment extends Fragment {
   ...
   // String link;
    ...
    private void FetchNotification() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, appConfig.URL_sendZoomLinkToSchoolAndTeacher,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < jba.length(); i++) {
                                ...
                                notifications = gson.fromJson(String.valueOf(jba.getJSONObject(i)), Notifications.class);
                            ...
                            notificationAdapter = new NotificationAdapter(notificationsArrayList, NotificationFragment.this);
