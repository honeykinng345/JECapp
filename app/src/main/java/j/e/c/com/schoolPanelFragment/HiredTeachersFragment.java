...
import j.e.c.com.schoolPanelFragment.SchoolAdapter.HiredTeachersAdapter;
...
public class HiredTeachersFragment extends Fragment {
    ...
    private HiredTeachersAdapter teacherAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        teacherAdapter = new HiredTeachersAdapter(teacherArrayList, this);
    ...
    private void reciveData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, appConfig.URL_ShowingHiredTeacherDetailsToSchool,
                        ...
                        try {
                            ...
                            for (int i = 0; i < jba.length(); i++) {
                                teacher = gson.fromJson(String.valueOf(jba.getJSONObject(i)), Teacher.class);
                                    String url = "http://192.168.0.124/j.e.c/bpic/" + teacher.getBpic();
                                    teacher.setBpic(url);
